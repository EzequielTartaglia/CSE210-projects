...
public class NPCSkull : BaseNPCharacter // NPCSkull child class of BaseNPCharacter
{
        ...
        //The default NPCSkull when we create
        public NPCSkull(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity) :base(lifePoints,manaPoints,level,physicalDamage,magicDamage,attackSpeed,celerity)
    {
        _life = lifePoints;
        _mana = manaPoints;
        _lvl = level;
     ...
     //With 1 parameters
     public NPCSkull(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity, string specialMoveTitle) :base(lifePoints,manaPoints,level,physicalDamage,magicDamage,attackSpeed,celerity)
    {
        _life = lifePoints;
        _mana = manaPoints;
        _lvl = level;
    ...
    //With 2 parameters
     public NPCSkull(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity, string specialMoveTitle, int specialMoveDamage) :base(lifePoints,manaPoints,level,physicalDamage,magicDamage,attackSpeed,celerity)
    {
        _life = lifePoints;
        _mana = manaPoints;
        _lvl = level;
