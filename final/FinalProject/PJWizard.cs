...
public class PJWizard : BasePlayerCharacter // PJWizard child class of BasePlayerCharacter
{
    ...
    public PJWizard(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity) :base(lifePoints,manaPoints,level,physicalDamage,magicDamage,attackSpeed,celerity)
    {
        //Default values
        _life = 1;
        _mana = 0;
    ...
    //With 1 parameter
    public PJWizard(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity, string specialMoveTitle) :base(lifePoints,manaPoints,level,physicalDamage,magicDamage,attackSpeed,celerity)
    {
        _life = 1;
        _mana = 0;
        _experience = 0;
    ...
    //With 2 parameter
    public PJWizard(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity, string specialMoveTitle, int specialMoveDamage) :base(lifePoints,manaPoints,level,physicalDamage,magicDamage,attackSpeed,celerity)
    {
        _life = 1;
        _mana = 0;
        _experience = 0;
