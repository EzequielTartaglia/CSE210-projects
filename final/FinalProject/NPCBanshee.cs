...
public class NPCBanshee : BaseNPCharacter // NPCBanshee child class of BaseNPCharacter
{
    ...
    //The default NPCBanshee when we create
    public NPCBanshee(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity) : base(lifePoints, manaPoints, level, physicalDamage, magicDamage, attackSpeed, celerity)
    {
        _life = lifePoints;
        _mana = manaPoints;
        _lvl = level;
    ...
    //With 1 parameters
    public NPCBanshee(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity, string specialMoveTitle) : base(lifePoints, manaPoints, level, physicalDamage, magicDamage, attackSpeed, celerity)
    {
        _life = lifePoints;
        _mana = manaPoints;
        _lvl = level;
    ...
    //With 2 parameters
    public NPCBanshee(int lifePoints, int manaPoints, int level, int physicalDamage, int magicDamage, int attackSpeed, int celerity, string specialMoveTitle, int specialMoveDamage) : base(lifePoints, manaPoints, level, physicalDamage, magicDamage, attackSpeed, celerity)
    {
        _life = lifePoints;
        _mana = manaPoints;
        _lvl = level;
